            ...
            <div class="container">
                <div class="row">
                    <div id="UpdatePanel1">
                            ...
                            <div class="col-md-12">
                                <h2 class="heading-title">Blood group information</h2>
                                <span class="title-tag inner-top-ss" style="color: red;">Note :- The assessment detail mentioned here is for your information only and will not be treated as an official copy. For any additional information regarding this detail, contact the Gram Panchayat office. </span>
                                            ...
                                            <table class="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="cart-qty item">Caste</th>
                                                        <th class="cart-product-name item">The space</th>
                                                        <th class="cart-edit item">Contact Number</th>
                                                        <th class="cart-qty item">Date of Birth</th>
                                                        <th class="cart-qty item">The Business</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php
