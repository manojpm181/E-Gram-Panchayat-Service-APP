...
if (isset($_POST['submitdata']) && $_POST['submitdata'] == 'Update') {
	...
	$history_story = $_POST['history_story'];   
...
//    
	$updatecategory = updatehistory($iCategoryID,$history_story);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = gethistoryDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>story*</label>
									<input type="text" class="form-control" id="history_story" name="history_story" required value="<?php echo (isset($categorydata['history_story']) && $categorydata['history_story'] != '') ? $categorydata['history_story'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								</div>
