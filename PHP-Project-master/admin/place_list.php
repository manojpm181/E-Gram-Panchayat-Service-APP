            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-outline" id="delete_yes">Yes</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td><a href='edit_place.php?cid=".$val['iCategoryID']."' role='button' class='btn btn btn-primary editcategory' data-toggle='modal'>Edit</a></td>&nbsp;&nbsp;";
                                        echo "<td><a href='placedelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn btn-danger'>Remove</a></td>&nbsp;&nbsp;";
                                        echo "</tr>";
                                    }
                                }
                                ?>
