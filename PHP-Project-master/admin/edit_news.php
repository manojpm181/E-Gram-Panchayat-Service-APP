...
//    
	$updatecategory = updatenews($iCategoryID,$news_name);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getnewsDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>news*</label>
									<input type="text" class="form-control" id="news_name" name="news_name" required value="<?php echo (isset($categorydata['news_name']) && $categorydata['news_name'] != '') ? $categorydata['news_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								</div>
