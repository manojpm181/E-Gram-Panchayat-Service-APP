...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
	...
	$updatecategory = updatecommitte($iCategoryID,$committe_name,$committe_vord_no,$committe_type,$committe_mo_no,$committe_bdate,$newfilename);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                     $categorydata = getcommitteDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="committe_name" name="committe_name" required value="<?php echo (isset($categorydata['committe_name']) && $categorydata['committe_name'] != '') ? $categorydata['committe_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div> 
								<div class="form-group">
                                    <label>committe_vord_no*</label>                                
                                    <input type="text" class="form-control" id="committe_vord_no" name="committe_vord_no" required value="<?php echo (isset($categorydata['committe_vord_no']) && $categorydata['committe_vord_no'] != '') ? $categorydata['committe_vord_no'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div> 
								<div class="form-group">
                                    <label>committe_type*</label>                                
                                    <input type="text" class="form-control" id="committe_type" name="committe_type" required value="<?php echo (isset($categorydata['committe_type']) && $categorydata['committe_type'] != '') ? $categorydata['committe_type'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>   
								<div class="form-group">
                                    <label>committe_mo_no*</label>                                
                                    <input type="text" class="form-control" id="committe_mo_no" name="committe_mo_no" required value="<?php echo (isset($categorydata['committe_mo_no']) && $categorydata['committe_mo_no'] != '') ? $categorydata['committe_mo_no'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div> 
								<div class="form-group">
                                    <label>committe_bdate*</label>                                
                                    <input type="date" class="form-control" id="committe_bdate" name="committe_bdate" required value="<?php echo (isset($categorydata['committe_bdate']) && $categorydata['committe_bdate'] != '') ? $categorydata['committe_bdate'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>    
								<div class="form-group product">
                                    ...
                                    <div class="fileinput fileinput-new col-sm-3 no-padding" data-provides="fileinput">
                                        <div class="imgdisplay">
                                            <?php if ($categorydata['committe_image'] != '') { ?>
                                                <img src="<?php echo "../" . $CATEGORY_IMAGE_URL . $categorydata['committe_image']; ?>" id="tImage" height='150' width='150'>
                                            <?php } else { ?>
                                        ...
                                        <div>
                                            <?php if ($categorydata['committe_image'] != '') { ?>
                                                <span class="btn btn-danger btn-file userpic">
                                                    ...
                                                    <input type="file" name="tImage"  title="Select Image" class="productimg" id="tImage1" data-img="<?php echo $categorydata['committe_id']; ?>" >
                                                </span>                                            
                                            <?php } else { ?>
                                                <span class="btn btn-danger btn-file userpic">
