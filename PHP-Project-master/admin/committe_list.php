                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td><a href='edit_committe.php?cid=".$val['iCategoryID']."' role='button' class='btn btn-primary editcategory' data-toggle='modal'>Edit</a></td>&nbsp;&nbsp;";
                                        echo "<td><a href='committedelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn-danger deletecategory' data-toggle='modal'>Remove</a></td>&nbsp;&nbsp;";
                                        echo "</tr>";
                                    }
                                }
                                ?>
