            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-outline" id="delete_yes">Yes</button>
                    </div>
                </div>
                <!-- /.modal-content -->
            </div>
                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td>
                                                <a href='edit_activity.php?cid=".$val['iCategoryID']."' role='button' class='btn btn-primary editcategory'>Edit</a>&nbsp;&nbsp;
                                                <a href='activitydelete.php?catid=".$val['iCategoryID']."' role='button' class='btn btn-danger deletecategory'>Remove</a>
                                              </td>";
                                        echo "</tr>";
                                    }
                                }
