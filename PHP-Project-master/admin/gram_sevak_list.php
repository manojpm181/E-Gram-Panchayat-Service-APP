                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td>" . $val['gram_sevak_name'] . "</td>";
                                        echo "<td>" . $val['gram_sevak_fb'] . "</td>";
                                        echo "<td>" . $val['gram_sevak_insta'] . "</td>";
                                        echo "<td>" . $val['gram_sevak_email'] . "</td>";
                                        echo "<td>" . $val['gram_sevak_no'] . "</td>";
                                        echo "<td><a href='edit_gram_sevak.php?cid=" . $val['iCategoryID'] . "' role='button' class='btn btn-primary editcategory' data-toggle='modal'>Edit</a>&nbsp;&nbsp;";
                                        echo "<a href='gram_sevakdelete.php?catid=" . $val['iCategoryID'] . "' role='button' class='btn btn-danger deletecategory' data-toggle='modal'>Remove</a></td>";
                                        echo "</tr>";
                                    }
                                }
                                ?>
