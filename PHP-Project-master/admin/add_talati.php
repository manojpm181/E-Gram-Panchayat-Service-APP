                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name*</label>                                
                                    <input type="text" class="form-control" id="talati_name" name="talati_name" required onkeypress="return spacerestri(event, this);">                                
                                </div>                               
                                <div class="form-group">
...
<!-- Remove image validation script -->
</body>
</html>
