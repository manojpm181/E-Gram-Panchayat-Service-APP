...
function login($username, $password) {
    ...
    $valid_username = 'max@gmail.com';
    $valid_password = 'Manoj@12345';

    if ($username === $valid_username && $password === $valid_password) {
        // Setting session variables upon successful login
        $_SESSION['email'] = $username;
        $_SESSION['user_id'] = 1;  // Assuming user ID 1 for this example
        $_SESSION['name'] = 'Max'; // Assuming the user's name is Max
        return true;
    }
    return false;
}
