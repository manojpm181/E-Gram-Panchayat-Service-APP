...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
	...
	$updatecategory = updateplace($iCategoryID,$place_name,$place_detail,$place_date,$newfilename);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getplaceDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="place_name" name="place_name" required value="<?php echo (isset($categorydata['place_name']) && $categorydata['place_name'] != '') ? $categorydata['place_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								<div class="form-group">
                                    <label>place_detail*</label>                                
                                    <input type="text" class="form-control" id="place_detail" name="place_detail" required value="<?php echo (isset($categorydata['place_detail']) && $categorydata['place_detail'] != '') ? $categorydata['place_detail'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>    
								<div class="form-group">
                                    <label>place_date*</label>                                
                                    <input type="date" class="form-control" id="place_date" name="place_date" required value="<?php echo (isset($categorydata['place_date']) && $categorydata['place_date'] != '') ? $categorydata['place_date'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>    
								<div class="form-group product">
                                    ...
                                    <div class="fileinput fileinput-new col-sm-3 no-padding" data-provides="fileinput">
                                        <div class="imgdisplay">
                                            <?php if ($categorydata['place_image'] != '') { ?>
                                                <img src="<?php echo "../" . $CATEGORY_IMAGE_URL . $categorydata['place_image']; ?>" id="tImage" height='150' width='150'>
                                            <?php } else { ?>
                                        ...
                                        <div>
                                            <?php if ($categorydata['place_image'] != '') { ?>
                                                <span class="btn btn-danger btn-file userpic">
                                                    ...
                                                    <input type="file" name="tImage"  title="Select Image" class="productimg" id="tImage1" data-img="<?php echo $categorydata['place_id']; ?>" >
                                                </span>                                            
                                            <?php } else { ?>
                                                <span class="btn btn-danger btn-file userpic">
