                            ...
                            <tbody>
                                ...
                                if (!empty($category_data)) {
                                    foreach ($category_data as $val) {
                                        ...
                                        echo "<td><a href='edit_talati.php?cid=" . $val['iCategoryID'] . "' role='button' class='btn btn-primary'>Edit</a></td>&nbsp;&nbsp;";
                                        echo "<td><a href='talatidelete.php?catid=" . $val['iCategoryID'] . "' role='button' class='btn btn-danger'>Remove</a></td>";
                                        echo "</tr>";
                                    }
                                }
                                ?>
