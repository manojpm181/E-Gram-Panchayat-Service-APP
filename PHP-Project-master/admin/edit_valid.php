...
//    
	$updatecategory = updatevalid($iCategoryID,$valid_start_date,$valid_end_date);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getvalidDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>valid_start*</label>
									<input type="date" class="form-control" id="valid_start_date" name="valid_start_date" required value="<?php echo (isset($categorydata['valid_start_date']) && $categorydata['valid_start_date'] != '') ? $categorydata['valid_start_date'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>
								<div class="form-group">
                                    <label>valid_end*</label>
									<input type="date" class="form-control" id="valid_end_date" name="valid_end_date" required value="<?php echo (isset($categorydata['valid_end_date']) && $categorydata['valid_end_date'] != '') ? $categorydata['valid_end_date'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>
								</div>
