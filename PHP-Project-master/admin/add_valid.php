...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addvalid($valid_start_date,$valid_end_date);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
								   ...
								   <label>valid_start_date*</label>                                
                                    <input type="date" class="form-control" id="valid_start_date" name="valid_start_date" required onkeypress="return spacerestri(event, this);">                                
                                 
								   <label>valid_end_date*</label>                                
                                    <input type="date" class="form-control" id="valid_end_date" name="valid_end_date" required onkeypress="return spacerestri(event, this);">                                
