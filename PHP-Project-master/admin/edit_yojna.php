...
//    
	$updatecategory = updateyojna($iCategoryID,$yojna_name,$yojna_link);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getyojnaDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>yojna name*</label>
									<input type="text" class="form-control" id="yojna_name" name="yojna_name" required value="<?php echo (isset($categorydata['yojna_name']) && $categorydata['yojna_name'] != '') ? $categorydata['yojna_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>        
								<div class="form-group">
                                    <label>yojna link*</label>
									<input type="text" class="form-control" id="yojna_link" name="yojna_link" required value="<?php echo (isset($categorydata['yojna_link']) && $categorydata['yojna_link'] != '') ? $categorydata['yojna_link'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>        
							</div>
