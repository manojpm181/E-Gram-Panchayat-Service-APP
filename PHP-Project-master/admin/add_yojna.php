...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
    ...
    $addcategory = addyojna($yojna_name,$yojna_link);
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
								   ...
								   <label>yojna Name*</label>                                
                                    <input type="text" class="form-control" id="yojna_name" name="yojna_name" required onkeypress="return spacerestri(event, this);">                                
                                 
								   <label>yojna link*</label>                                
                                    <input type="text" class="form-control" id="yojna_link" name="yojna_link" required onkeypress="return spacerestri(event, this);">                                
