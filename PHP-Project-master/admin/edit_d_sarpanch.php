...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
	...
	$updatecategory = updated_sarpanch($iCategoryID,$sarpanch_name,$mobile_no,$fb_id,$email_id,$insta_id,$twitter_id,$newfilename);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getd_sarpanchDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name*</label>                                
                                    <input type="text" class="form-control" id="sarpanch_name" name="sarpanch_name" required value="<?php echo (isset($categorydata['d_sarpanch_name']) && $categorydata['d_sarpanch_name'] != '') ? $categorydata['d_sarpanch_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								<div class="form-group">
                                    <label>Mobile No.*</label>                                
                                    <input type="text" class="form-control" id="mobile_no" name="mobile_no" required value="<?php echo (isset($categorydata['d_sarpanch_no']) && $categorydata['d_sarpanch_no'] != '') ? $categorydata['d_sarpanch_no'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								<div class="form-group">
                                    <label>Facebook link*</label>                                
                                    <input type="text" class="form-control" id="fb_id" name="fb_id" required value="<?php echo (isset($categorydata['d_sarpanch_fb']) && $categorydata['d_sarpanch_fb'] != '') ? $categorydata['d_sarpanch_fb'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								<div class="form-group">
                                    <label>Email*</label>                                
                                    <input type="text" class="form-control" id="email_id" name="email_id" required value="<?php echo (isset($categorydata['d_sarpanch_email']) && $categorydata['d_sarpanch_email'] != '') ? $categorydata['d_sarpanch_email'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								<div class="form-group">
                                    <label>Instagram Link*</label>                                
                                    <input type="text" class="form-control" id="insta_id" name="insta_id" required value="<?php echo (isset($categorydata['d_sarpanch_insta']) && $categorydata['d_sarpanch_insta'] != '') ? $categorydata['d_sarpanch_insta'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>
								<div class="form-group">
                                    <label>Twitter Link*</label>                                
                                    <input type="text" class="form-control" id="twitter_id" name="twitter_id" required value="<?php echo (isset($categorydata['d_sarpanch_twitter']) && $categorydata['d_sarpanch_twitter'] != '') ? $categorydata['d_sarpanch_twitter'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>
                                <div class="form-group product">
                                    ...
                                    <div class="fileinput fileinput-new col-sm-3 no-padding" data-provides="fileinput">
                                        <div class="imgdisplay">
                                            <?php if ($categorydata['d_sarpanch_image'] != '') { ?>
                                                <img src="<?php echo "../" . $CATEGORY_IMAGE_URL . $categorydata['d_sarpanch_image']; ?>" id="tImage" height='150' width='150'>
                                            <?php } else { ?>
                                        ...
                                        <div>
                                            <?php if ($categorydata['d_sarpanch_image'] != '') { ?>
                                                <span class="btn btn-danger btn-file userpic">
                                                    ...
                                                    <input type="file" name="tImage"  title="Select Image" class="productimg" id="tImage1" data-img="<?php echo $categorydata['d_sarpanch_id']; ?>" >
                                                </span>                                            
                                            <?php } else { ?>
                                                <span class="btn btn-danger btn-file userpic">
