...
//        chmod($EVENT_IMAGE_THUMB_PATH . $newfilename, 0777);
	...
	$updatecategory = updateactivity($iCategoryID,$activity_name,$activity_detail,$activity_date,$newfilename);
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="addevent" name="eventform" enctype="multipart/form-data">
                ...
                if (isset($_REQUEST['cid']) && $_REQUEST['cid'] != '') {
                    $categorydata = getactivityDataByID($_REQUEST['cid']);
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="activity_name" name="activity_name" required value="<?php echo (isset($categorydata['activity_name']) && $categorydata['activity_name'] != '') ? $categorydata['activity_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
								<div class="form-group">
                                    <label>activity_detail*</label>                                
                                    <input type="text" class="form-control" id="activity_detail" name="activity_detail" required value="<?php echo (isset($categorydata['activity_detail']) && $categorydata['activity_detail'] != '') ? $categorydata['activity_detail'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>    
								<div class="form-group">
                                    <label>activity_date*</label>                                
                                    <input type="date" class="form-control" id="activity_date" name="activity_date" required value="<?php echo (isset($categorydata['activity_date']) && $categorydata['activity_date'] != '') ? $categorydata['activity_date'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>    
								<div class="form-group product">
                                    ...
                                    <div class="fileinput fileinput-new col-sm-3 no-padding" data-provides="fileinput">
                                        <div class="imgdisplay">
                                            <?php if ($categorydata['activity_image'] != '') { ?>
                                                <img src="<?php echo "../" . $CATEGORY_IMAGE_URL . $categorydata['activity_image']; ?>" id="tImage" height='150' width='150'>
                                            <?php } else { ?>
                                        ...
                                        <div>
                                            <?php if ($categorydata['activity_image'] != '') { ?>
                                                <span class="btn btn-danger btn-file userpic">
                                                    ...
                                                    <input type="file" name="tImage"  title="Select Image" class="productimg" id="tImage1" data-img="<?php echo $categorydata['activity_id']; ?>" >
                                                </span>                                            
                                            <?php } else { ?>
                                                <span class="btn btn-danger btn-file userpic">
