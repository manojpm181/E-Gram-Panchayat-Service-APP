                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Name*</label>                                
                                    <input type="text" class="form-control" id="vCategoryName" name="vCategoryName" required value="<?php echo (isset($categorydata['banner_name']) && $categorydata['banner_name'] != '') ? $categorydata['banner_name'] : '' ?>" onkeypress="return spacerestri(event, this);">                                
                                </div>                              
                                ...
                                <div class="form-group product">
                                    ...
                                    <div class="fileinput fileinput-new col-sm-3 no-padding" data-provides="fileinput">
                                        <div class="imgdisplay">
                                            <?php if ($categorydata['banner_image'] != '') { ?>
                                                <img src="<?php echo "../". $CATEGORY_IMAGE_URL . $categorydata['banner_image']; ?>" id="tImage" height='150' width='150'>
